...
@section('content')
    ...
    <div class="theme-inner-banner">
        ...
        <img src="/user_assets/images/shape/shape_38.svg" alt="" class="shapes shape-one">
        <img src="/user_assets/images/shape/shape_39.svg" alt="" class="shapes shape-two">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="address-block-two text-center mb-40 sm-mb-20">
                        <div class="icon d-flex align-items-center justify-content-center m-auto"><img
                                src="/user_assets/images/icon/icon_17.svg" alt=""></div>
                ...
                <div class="col-md-4">
                    <div class="address-block-two text-center mb-40 sm-mb-20">
                        <div class="icon d-flex align-items-center justify-content-center m-auto"><img
                                src="/user_assets/images/icon/icon_18.svg" alt=""></div>
                ...
                <div class="col-md-4">
                    <div class="address-block-two text-center mb-40 sm-mb-20">
                        <div class="icon d-flex align-items-center justify-content-center m-auto"><img
                                src="/user_assets/images/icon/icon_19.svg" alt=""></div>
                ...
                <div class="row gx-xxl-5">
                    <div class="col-lg-6 d-flex order-lg-last">
                        <div class="form-style-one">
                            ...
                            <form action="/user_assets/inc/contact.php" id="contact-form" data-toggle="validator">
                                <div class="messages"></div>
                                <div class="row controls">
                                    <div class="col-12">
                                        <div class="input-group-meta form-group mb-30">
                                            <label>Name*</label>
                                            <input type="text" placeholder="Rashed Kabir" name="name"
                                    ...
                                    <div class="col-12">
                                        <div class="input-group-meta form-group mb-30">
                                            <label>Email*</label>
                                            <input type="email" placeholder="rshdkabir@gmail.com" name="email"
